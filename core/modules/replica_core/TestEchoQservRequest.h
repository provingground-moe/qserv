...
#ifndef LSST_QSERV_REPLICA_CORE_TEST_ECHO_QSERV_REQUEST_H
#define LSST_QSERV_REPLICA_CORE_TEST_ECHO_QSERV_REQUEST_H
...
#endif // LSST_QSERV_REPLICA_CORE_TEST_ECHO_QSERV_REQUEST_H