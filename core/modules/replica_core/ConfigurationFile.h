 ...
 */
#ifndef LSST_QSERV_REPLICA_CORE_CONFIGURATION_FILE_H
#define LSST_QSERV_REPLICA_CORE_CONFIGURATION_FILE_H
...
#endif // LSST_QSERV_REPLICA_CORE_CONFIGURATION_FILE_H