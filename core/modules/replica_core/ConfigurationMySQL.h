 ...
 */
#ifndef LSST_QSERV_REPLICA_CORE_CONFIGURATION_MYSQL_H
#define LSST_QSERV_REPLICA_CORE_CONFIGURATION_MYSQL_H
...
#endif // LSST_QSERV_REPLICA_CORE_CONFIGURATION_MYSQL_H