...
private:
     ...
     */
    boost::system::error_code syncReadFrame (replica_core::ProtocolBuffer& buf,
                                             size_t&                       bytes);
   ...
   /**
     ...
     * @return the completion code of the operation
     */
    boost::system::error_code syncReadVerifyHeader (replica_core::ProtocolBuffer& buf,
                                                    size_t                        bytes,
                                                    std::string const&            id);
     ...
     * @return the completion code of the operation
     */
    boost::system::error_code syncReadMessageImpl (replica_core::ProtocolBuffer& buf,
                                                   size_t                        bytes);
