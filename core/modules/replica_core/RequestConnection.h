 ...
 */
#ifndef LSST_QSERV_REPLICA_CORE_REQUEST_CONNECTION_H
#define LSST_QSERV_REPLICA_CORE_REQUEST_CONNECTION_H
...
#endif // LSST_QSERV_REPLICA_CORE_REQUEST_CONNECTION_H