 ...
 */
#ifndef LSST_QSERV_REPLICA_CORE_REQUEST_MESSENGER_H
#define LSST_QSERV_REPLICA_CORE_REQUEST_MESSENGER_H
...
#endif // LSST_QSERV_REPLICA_CORE_REQUEST_MESSENGER_H