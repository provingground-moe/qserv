 ...
 */
#ifndef LSST_QSERV_REPLICA_REPLICA_FINDER_H
#define LSST_QSERV_REPLICA_REPLICA_FINDER_H
...
public:
     ...
     *                         of the operation
     */
    ReplicaFinder (replica_core::Controller::pointer const& controller,
    ...
    /// Destructor
    virtual ~ReplicaFinder ();
};

}}} // namespace lsst::qserv::replica

#endif // LSST_QSERV_REPLICA_REPLICA_FINDER_H
