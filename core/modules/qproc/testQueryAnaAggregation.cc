...
BOOST_AUTO_TEST_CASE(Aggregate) {
    ...
    std::string expPar = "SELECT sum(`LSST.Object`.pm_declErr) AS QS1_SUM,`LSST.Object`.chunkId AS`chunkId`,COUNT(`LSST.Object`.bMagF2) AS QS2_COUNT,SUM(`LSST.Object`.bMagF2) AS QS3_SUM FROM LSST.Object_100 AS`LSST.Object`WHERE bMagF>20.0 GROUP BY`chunkId`";
...
BOOST_AUTO_TEST_CASE(Avg) {
    ...
    std::string expPar = "SELECT `LSST.Object`.chunkId AS`chunkId`,COUNT(`LSST.Object`.bMagF2) AS QS1_COUNT,SUM(`LSST.Object`.bMagF2) AS QS2_SUM FROM LSST.Object_100 AS`LSST.Object`WHERE bMagF>20.0";
